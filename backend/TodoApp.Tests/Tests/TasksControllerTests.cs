...
public class TasksControllerTests
{
    ...
    {
        _mockService.Setup(s => s.GetByIdAsync(1)).ReturnsAsync(new TaskDto { Id = 1, Title = "Test", TodoListId = 1 });
    ...
    {
        _mockService.Setup(s => s.GetByIdAsync(99)).ReturnsAsync((TaskDto?)null);
    ...
    public async Task Post_ReturnsOk_WhenTaskCreated()
    {
        ...
        _mockService.Setup(s => s.AddAsync(dto)).ReturnsAsync(new TaskDto { Id = 2, Title = "New Task", TodoListId = 1 });
    ...
    public async Task Put_ReturnsOk_WhenTaskUpdated()
    {
        ...
        _mockService.Setup(s => s.UpdateAsync(dto)).ReturnsAsync(new TaskDto { Id = 1, Title = "Updated Task", TodoListId = 1 });
